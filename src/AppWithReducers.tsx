...
function AppWithReducers() {
    ...
    let [todolists, dispatchTodolists]: [TodolistType[], Dispatch<ActionsTypeTodoR>] = useReducer(todolistsReducer, [
        {id: todolistId1, title: "What to learn", filter: "all"},
        {id: todolistId2, title: "What to buy", filter: "all"}
    ])

    let [tasks, dispatchTasks]: [TasksStateType, Dispatch<ActionsTypeTaskR>] = useReducer(tasksReducer, {
        [todolistId1]: [

...
test('correct todolist should be removed', () => {
    let deletedTodolist = {id: todolistId1}
    const endState = todolistsReducer(startState, removeTodolistTC.fulfilled({id: todolistId1}, "", {todolistId: deletedTodolist.id}))
...
test('correct todolist should be added', () => {
    ...
    const endState = todolistsReducer(startState, addTodolistTC.fulfilled({todolist: todolist}, "", {title: todolist.title}))
